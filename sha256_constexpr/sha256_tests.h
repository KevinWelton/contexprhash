...
{
    void print_result(const char* test_name, const hash_result result, const char* expected)
    {
        printf("Test    : %s\n", test_name);
        printf("SHA256  : ");
    ...
    void sha256_tests()
    {
        ...
        constexpr hash_result almostfullchunk_str_result = sha256(almostfullchunk_str);
        ...
        constexpr hash_result fullchunk_str_result = sha256(fullchunk_str);
        ...
        constexpr hash_result fullchunk_and_a_half_str_result = sha256(fullchunk_and_a_half_str);
        ...
        constexpr hash_result twofullchunks_str_result = sha256(twofullchunks_str);
        ...
        constexpr hash_result long_str_result = sha256(long_str);
